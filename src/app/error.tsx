...
export default function Error({
    ...
    useEffect(() => {
        // En un entorno real, aquí se enviarían los logs a un servicio tipo Sentry
        console.error(error);
    }, [error]);
    ...
    return (
        <main className="relative flex flex-col items-center justify-center min-h-screen bg-[#f2f0f4] overflow-hidden text-center selection:bg-black/10 selection:text-black">
            ...
            <motion.div
                ...
                className="absolute top-12 lg:top-20 left-0 right-0 z-50 flex justify-center px-8 pointer-events-none"
            >
            ...
            <div className="relative z-20 flex flex-col items-center space-y-12 max-w-2xl px-8">
                <motion.div
                    ...
                    className="space-y-6"
                >
                    <p className="text-[10px] tracking-[0.6em] uppercase font-bold text-black/40">Incidencia Técnica</p>
                    <h1 className="text-5xl lg:text-7xl font-light text-black leading-tight">
                        Interrupción <br />
                        <span className="font-serif italic text-black/50">inesperada.</span>
                    </h1>
                </motion.div>
                ...
                >
                    Incluso en los protocolos más precisos, surgen pausas necesarias.
                    Nuestro equipo técnico ya está restaurando el equilibrio.
                </motion.p>
                ...
                >
                    ...
                    >
                        <span className="relative z-10 block px-12 py-4 bg-white text-black text-xs tracking-[0.2em] uppercase font-bold rounded-full border border-black/5 shadow-premium-levitation group-hover:bg-black group-hover:text-white transition-all duration-500 group-hover:scale-105">
                            Reintentar Conexión
                        </span>
                    </button>
                </motion.div>
